...
# Now that pip is installed, install the specific Quant tools (added requests)
RUN pip3 install yfinance pandas requests --break-system-packages || pip3 install yfinance pandas requests
